  ...
  return (
    <div className="w-full h-full relative overflow-hidden bg-background">
      ...
      <div className="absolute top-4 left-4 right-4 z-10 flex items-center justify-between pointer-events-none">
          {/* Breadcrumb & Title */}
          <div className="flex items-center gap-2 pointer-events-auto glass-float p-1.5 pl-2 pr-4 rounded-full">
              <Link to="/pipelines">
          ...
          {/* Action Buttons */}
          <div className="flex items-center gap-2 pointer-events-auto glass-float p-1.5 rounded-full">
            {!isNew && (
                <Button 
                    variant="ghost" 
                    size="sm" 
      ...
      >
        ...
        <Controls 
            className="glass-float rounded-2xl overflow-hidden m-4 border-none text-foreground fill-foreground" 
            showInteractive={false}
        />
        
        <MiniMap 
            className="glass-float rounded-2xl overflow-hidden m-4 border-none" 
            nodeColor={(node) => {
        ...
        <Panel position="top-center" className="mt-20 pointer-events-none">
            <div className="flex items-center gap-1.5 p-2 glass-float rounded-full pointer-events-auto">
      ...
      <div className={cn(
          "absolute top-4 bottom-4 right-4 w-[380px] glass-panel transition-all duration-500 cubic-bezier(0.32, 0.72, 0, 1) flex flex-col overflow-hidden z-20",
